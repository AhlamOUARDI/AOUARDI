...
I am a mathematics teacher, currently pursuing a **doctoral program** in applied mathematics and modeling at [**UM6P-EMINES School of Industrial Management**](https://www.emines-ingenieur.org/), with a focus on **Nonlinear and implicit port-Hamiltonian models of sloshing in 1D: theoretical analysis and structure-preserving numerical methods**. My research interest sits at the intersection of mathematics, biomedical sciences, and engineering, with a particular focus on port-Hamiltonian systems, optimal control, inverse problems, and data-driven models.

My academic journey was deepened through engineering studies at [**EMINES**], where I explored diverse disciplines—from computational fluid dynamics to biomedical engineering. A formative internship at [**MAScIR**](https://www.mascir.com/) introduced me to research on tuberculosis diagnostics and wearable biosensing, igniting my interest in biology-driven applications of mathematics.
